...
function CommandDialog({
  ...
  /**
   * Forwarded to cmdk. Pass `false` when the caller filters the list itself —
   * cmdk's default filter matches on each item's `value`, and an opaque value
   * (an id) would hide rows the caller already decided to show.
   */
