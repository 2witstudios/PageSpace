...
function SidebarProvider({
  ...
  React.useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      if (matchesKeyEvent(getEffectiveBinding('navigation.toggle-sidebar'), event)) {
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "data-[active=true]:bg-primary-soft data-[active=true]:text-sidebar-accent-foreground",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
