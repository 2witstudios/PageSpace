...
describe('PaneSessionIdentity', () => {
  test('shows the session name and its agent label', () => {
    ...
    assert({
      given: 'a bound chat pane\'s identity',
      should: 'name the session and which agent it belongs to — a grid holding conversations with several agents stays legible',
      actual: {
