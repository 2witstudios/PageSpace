...
export default async function Home() {
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex h-14 items-center px-4 sm:px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-2">
            <Image src="/android-chrome-192x192.png" alt="PageSpace" width={20} height={20} className="rounded" />
  ...
  health_check: /api/health`}</code></pre>
        ...
        {/* Pricing Section */}
        <section id="pricing" className="border-t border-border w-full py-20 md:py-32 lg:py-40 bg-background">
          <div className="container mx-auto px-4 md:px-6">
      ...
      <footer className="w-full border-t bg-background text-foreground">
        <div className="container mx-auto flex flex-col gap-2 sm:flex-row py-6 shrink-0 items-center px-4 md:px-6">
          <p className="text-xs text-muted-foreground">
            &copy; 2025 pagespace. All rights reserved.
          </p>
