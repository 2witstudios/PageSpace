...
const del = () =>
  DELETE(
    new Request(`http://localhost/api/agent-sessions/${SESSION_ID}/conversations/${CONVERSATION_ID}`, {
      method: 'DELETE',
    }),
    params,
  );
...
describe('DELETE /api/agent-sessions/[sessionId]/conversations/[conversationId]', () => {
