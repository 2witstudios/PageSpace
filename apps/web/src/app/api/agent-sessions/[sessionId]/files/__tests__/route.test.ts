...
const get = (query: string) =>
  GET(new Request(`http://localhost/api/agent-sessions/${SESSION_ID}/files${query}`), params);
const jsonRequest = (method: string, body: unknown) =>
  new Request(`http://localhost/api/agent-sessions/${SESSION_ID}/files`, {
    method,
...
describe('GET /api/agent-sessions/[sessionId]/files', () => {
...
describe('POST /api/agent-sessions/[sessionId]/files', () => {
...
describe('DELETE /api/agent-sessions/[sessionId]/files', () => {
