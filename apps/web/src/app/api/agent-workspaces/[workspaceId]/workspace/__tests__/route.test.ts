...
/**
 * GET/PUT `/api/agent-workspaces/[workspaceId]/workspace` — what matters here is
...
const get = () => GET(new Request(`http://localhost/api/agent-workspaces/${SESSION_ID}/workspace`), params);
const put = (body?: unknown) =>
  PUT(
    new Request(`http://localhost/api/agent-workspaces/${SESSION_ID}/workspace`, {
      method: 'PUT',
      ...(body !== undefined
...
describe('GET /api/agent-workspaces/[workspaceId]/workspace', () => {
...
describe('PUT /api/agent-workspaces/[workspaceId]/workspace (retired)', () => {
