...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    auditRequest(request, { eventType: 'data.write', userId, resourceType: 'subscription_schedule', resourceId: currentSubscription.stripeScheduleId, details: { action: 'cancel' } });
