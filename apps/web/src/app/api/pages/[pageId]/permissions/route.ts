...
export async function POST(req: Request, { params }: { params: Promise<{ pageId: string }> }) {
  ...
  try {
    ...
    audit({ eventType: 'authz.permission.granted', userId: ctx.userId, resourceType: 'page', resourceId: pageId, details: { targetUserId, canView, canEdit } });
...
export async function DELETE(req: Request, { params }: { params: Promise<{ pageId: string }> }) {
  ...
  try {
    ...
    if (result.data.revoked) {
      ...
      audit({ eventType: 'authz.permission.revoked', userId: ctx.userId, resourceType: 'page', resourceId: pageId, details: { targetUserId } });
