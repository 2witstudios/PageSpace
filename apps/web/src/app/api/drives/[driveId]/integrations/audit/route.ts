...
export async function GET(
  ...
  try {
    ...
    securityAudit.logDataAccess(auth.userId, 'read', 'drive_integration_audit', driveId, { operation: 'view_integration_audit' })?.catch(e => loggers.auth.warn('Audit log failed', e));
