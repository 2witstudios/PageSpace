...
export async function PATCH(
  ...
  try {
    ...
    auditRequest(request, { eventType: 'authz.role.assigned', userId, resourceType: 'drive', resourceId: driveId, details: { operation: 'reorder', previousOrder, newOrder: roleIds } });
