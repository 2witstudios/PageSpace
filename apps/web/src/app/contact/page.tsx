...
import { ArrowLeft, Mail, MessageSquare, User, Building } from "lucide-react";
          ...
          <div className="container mx-auto px-4 md:px-6 max-w-2xl">
            <Card className="text-center">
              <CardHeader>
                ...
                <CardTitle className="text-2xl">Thank you for reaching out!</CardTitle>
              ...
              <CardContent className="space-y-6">
                <p className="text-muted-foreground">
                  Our team will review your inquiry and respond via email as soon as possible.
                </p>
