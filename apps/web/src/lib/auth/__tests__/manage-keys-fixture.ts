...
export function manageKeysScopedAuthResult(
  ...
  return {
    ...
    scopes: { account: false, offlineAccess: false, drives: new Map(), manageKeys: true, allDrives: false, updateKeyId: null, activateKeyId: null, newKeyName: null },
    driveScopes: [],
    allowedDriveIds: [],
    ...overrides,
  };
...
export function driveScopedOAuthAuthResult(
  ...
  return {
    ...
    scopes: {
      ...
      manageKeys: false,
      allDrives: false,
      updateKeyId: null, activateKeyId: null, newKeyName: null,
