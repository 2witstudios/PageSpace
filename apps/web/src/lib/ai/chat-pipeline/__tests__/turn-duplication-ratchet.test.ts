 ...
 */
// 161 → 182 (Tool Approvals epic): the 21 new identical lines are the mechanical
// seams of the approval gate — five imports, the `approvedExecutions` /
...
// decision or effect.
const RECORDED_IDENTICAL_LINES = 182;
