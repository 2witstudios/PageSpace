...
export type TaskOperation = 'task_list_created' | 'task_added' | 'task_updated' | 'task_completed' | 'task_deleted' | 'tasks_reordered' | 'dependency_added' | 'dependency_removed' | 'task_linked' | 'task_unlinked';
