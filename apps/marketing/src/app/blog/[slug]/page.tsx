        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Start free with {FREE_STARTER_CREDITS_DISPLAY} credits. No credit card
              required.
            </p>
