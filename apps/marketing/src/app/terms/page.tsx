      ...
      <div className="container mx-auto px-4 py-12 md:py-16 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none dark:prose-invert">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Your use of PageSpace is also governed by our <Link href="/privacy" className="text-primary hover:underline">Privacy Policy</Link>. By using our service, you agree to our data collection and processing practices as described in the Privacy Policy.
            </p>
            <p className="mb-4">
