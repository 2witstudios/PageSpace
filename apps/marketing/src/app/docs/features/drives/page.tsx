...
- **Agents and apps** — AI agent pages and connected apps (MCP tokens) also appear on the member roster, each with its own role. They can never reach more than the member who added them, and lose access automatically if that member is removed.
