...
const features = [
  ...
  { title: "Documents", href: "/docs/how-it-works/documents", icon: FileText, description: "Rich-text pages with real-time collaboration, slash commands, and AI that can read and edit." },
  { title: "Folders", href: "/docs/how-it-works/folders", icon: Folder, description: "Containers that group pages in the tree — how nesting, drag-drop, and ordering work." },
  ...
  { title: "Sheets", href: "/docs/how-it-works/sheets", icon: Table, description: "Spreadsheets with formulas, real-time cells, and AI that can read and analyse your data." },
  { title: "Canvas", href: "/docs/how-it-works/canvas", icon: Palette, description: "Custom HTML/CSS pages in an isolated Shadow DOM — for dashboards, widgets, and visual tools." },
  { title: "Code", href: "/docs/how-it-works/code", icon: Code, description: "A Monaco-powered code editor page with syntax highlighting and real-time collaboration." },
