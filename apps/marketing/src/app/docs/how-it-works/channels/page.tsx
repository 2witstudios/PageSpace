...
export const metadata = createMetadata({
  ...
  path: "/docs/how-it-works/channels",
...
- [Pages](/docs/how-it-works/pages) — channels are a page type, so everything pages do (move, share, version the title) applies.
- [Sharing & Permissions](/docs/how-it-works/sharing) — who can read versus post in a channel, and how to change that.
- [AI in your Workspace](/docs/how-it-works/ai) — what an @mentioned agent can actually do when you call it into a channel.
- [Files & Uploads](/docs/how-it-works/files) — what happens to the files you drop into a message.
`;
