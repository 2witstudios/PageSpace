...
export const metadata = createMetadata({
  ...
  path: "/docs/how-it-works/task-lists",
...
- See everything assigned to you across every [drive](/docs/how-it-works/drives) at **My Tasks**, or filter a single drive's tasks from its Tasks view.
...
- [Pages](/docs/how-it-works/pages) — every task is backed by a Document page, and Task Lists follow the same permissions, sharing, and trash rules as any other page.
- [AI in your Workspace](/docs/how-it-works/ai) — how agents pick up assigned work and run on triggers.
- [Channels](/docs/how-it-works/channels) — where task discussion usually happens.
