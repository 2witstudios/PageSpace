...
export const metadata = createMetadata({
  ...
  path: "/docs/how-it-works/sharing",
...
- [Drives & Workspaces](/docs/how-it-works/drives) — how drives group pages and members.
- [Pages](/docs/how-it-works/pages) — the thing you're actually sharing.
