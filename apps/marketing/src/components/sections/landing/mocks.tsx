...
export const PAGE_TYPES: PageType[] = [
  ...
  { id: "document", label: "Document", icon: "fileText", parent: "Product Launch", title: "Q1 Planning", actions: <><span className="pill on">Rich</span><span className="pill">Code</span></>, desc: "Rich-text pages with markdown, real-time collaboration, and version history.", Body: DocMock },
