...
ALTER TABLE "credit_balances" ADD CONSTRAINT "credit_balances_pending_millicents_range" CHECK ("pendingMillicents" >= 0 AND "pendingMillicents" < 1000);--> statement-breakpoint
