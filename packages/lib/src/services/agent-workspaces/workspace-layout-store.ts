 ...
 * `agent_workspaces.workspaceState` blob was dropped at Phase 3's contract
 ...
 * lock never lands on the `agent_workspaces` row that sandbox teardown/ensure
...
import type { PaneKind } from '../../agent-workspaces/contract';
import { quantizeFraction, type LayoutGridColumn } from '../../agent-workspaces/workspace-layout-verbs';
