 ...
 * (`apps/web/src/lib/agent-workspaces/workspace-layout-runtime.ts`) run the
 ...
 * (`services/agent-workspaces/workspace-layout-store.ts`'s
...
export function applyVerbLocal(
  ...
  switch (verb.type) {
    case 'ensure': {
      ...
      return {
        state: newWorkspace({ workspaceId: workspaceId, paneId: verb.paneId, columnId: verb.columnId, scope: verb.scope }),
        applied: true,
      };
    }
    ...
    case 'open_conversation': {
      if (!state) {
        return {
          state: newWorkspace({ workspaceId: workspaceId, paneId: verb.newPaneId, columnId: verb.newColumnId, scope: verb.scope }),
          applied: true,
        };
      }
