...
describe('adversarial: password-kind-channel', () => {
  ...
  it.todo('given kind password requested with a VerifiedGrant whose aud is the unnarrowed PresenterChannel union, should not compile (store-adapter.types.test.ts, tsc) [0005 §10.22; G1a review H6]');
