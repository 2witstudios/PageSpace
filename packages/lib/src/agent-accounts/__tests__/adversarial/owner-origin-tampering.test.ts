...
describe('adversarial: owner-origin-tampering', () => {
  ...
  it.todo('given a widening performed through put with step-up, should rewrite bindings and subsequent resolve should succeed — I/O row, owned by G1b-store (plane bindings at resolve)');
});
