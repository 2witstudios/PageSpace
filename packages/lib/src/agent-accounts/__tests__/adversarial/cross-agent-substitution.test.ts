...
describe('adversarial: cross-agent-substitution', () => {
  ...
  it.todo('given a tool that claims repo A in its arguments while the URL targets repo B, should derive resources [repo,B] from the path and refuse under a repo-A-scoped policy (out_of_scope) [G1a review M8]');
