...
describe('planLeadReassignments', () => {
  it('O-7 every org drive the departing lead leads goes to that org\'s Owner', () => {
  ...
  it('O-7 a drive the org Owner already leads is not reassigned to itself', () => {
    expect(planLeadReassignments('owner1', [
      { driveId: 'd1', orgId: 'o1', orgOwnerId: 'owner1' },
    ])).toEqual([]);
  });

  it('O-7 no led org drives means no reassignments', () => {
