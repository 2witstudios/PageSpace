          ...
          <Section style={emailStyles.content}>
            ...
            <Section style={calloutCard}>
              ...
              <Text style={calloutText}>
                {summary.unlocksPremiumModels
                  ? 'Your plan unlocks the frontier — spend credits on Claude Opus, the GPT-5.5 family, OpenAI o3, GLM-5, and more. Reach for a light model on quick work and a flagship when it counts. You choose the trade-off per task.'
