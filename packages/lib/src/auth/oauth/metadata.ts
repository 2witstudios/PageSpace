...
/**
 * ADR 0002 Decision 1 grammar, as amended by ADR 0004 (`profile`). `drive:*`
 * stands for the templated `drive:<driveId>[:role]` family.
 */
const SCOPES_SUPPORTED = ['account', 'profile', 'offline_access', 'manage_keys', 'drive:*'] as const;
