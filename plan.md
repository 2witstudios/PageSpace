...
- [BYOK Retirement](tasks/byok-retirement.md) — Retire user-supplied AI provider keys; route all AI calls through deployment-managed env keys with the existing per-tier rate limit gate.
