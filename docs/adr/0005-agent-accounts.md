...
- Whether an unclaimed agent can DM, invite or upload is decided by **[D-29]** through the single `emailVerified` stamp; no gate is edited either way.
