...
The PageSpace codebase contains **over 320 documented functions** across 9 major categories:
...
4. **AI & LLM Functions** (37 functions): AI integration, enhanced search tools, task management, batch operations, and monitoring
