...
## Global AI Conversations Routes

### GET, POST /api/ai/global
**Purpose:** Global AI conversation management. GET lists user's global AI conversations, POST creates new global AI conversation contexts.

### GET, PATCH, DELETE /api/ai/global/[id]
**Purpose:** Individual global AI conversation operations for metadata and lifecycle management.

### GET, POST /api/ai/global/[id]/messages
**Purpose:** Manages global AI conversation message history and real-time chat functionality.
...
## Page Agent Management Routes

### POST /api/ai/page-agents/create
**Purpose:** Create new page-based AI agents with custom configuration and tools.

### GET, PATCH /api/ai/page-agents/[agentId]/config
**Purpose:** Manage individual page agent configuration, system prompts, and enabled tools.

### GET, POST /api/ai/page-agents/[agentId]/conversations
**Purpose:** List and create conversations for a specific page agent.

### GET, PATCH, DELETE /api/ai/page-agents/[agentId]/conversations/[conversationId]
**Purpose:** Manage individual page agent conversations.

### GET, POST /api/ai/page-agents/[agentId]/conversations/[conversationId]/messages
**Purpose:** List and send messages in a page agent conversation.

### POST /api/ai/page-agents/consult
**Purpose:** Consult a page agent for specialized knowledge (agent-to-agent communication).

### GET /api/ai/page-agents/multi-drive
**Purpose:** List all page agents across multiple drives with filtering options.
