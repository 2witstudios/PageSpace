...
| Google LLC (Firebase Cloud Messaging) | Push notifications to Android app | Device registration token, notification payload (no message content beyond what's needed to render the notification) | `[TODO: confirm signed DPA on file — Y/N/date]` |
