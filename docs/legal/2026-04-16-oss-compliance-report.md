...
Default recommendation from the seller: **(b) rotate** — minimises
...
the 2,104-package npm / pnpm dependency graph that backs the web, realtime,
...
### 5.4 npm / pnpm dependency inventory (2,104 packages)
