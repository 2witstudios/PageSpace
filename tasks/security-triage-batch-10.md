...
- **`packages/lib/src/auth/csrf-utils.ts`**: Same timing side-channel pattern — consolidated to `secureCompare` from `@pagespace/lib/auth/secure-compare`.
